...
contract HoneyQueenV4 is UUPSUpgradeable, OwnableUpgradeable {
    /*###############################################################
                            ERRORS
    ###############################################################*/
    ...
    function setInfrared(address _infrared) external onlyOwner {
        infrared = _infrared;
    }

    function setInfraredBGT(address _infraredBGT) external onlyOwner {
        infraredBGT = _infraredBGT;
    }
    /*###############################################################
                            EXTERNAL FUNCTIONS
    ###############################################################*/
